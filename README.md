...
[![Playwright](https://img.shields.io/badge/Playwright-MCP-2EAD33?logo=playwright&logoColor=white)](https://github.com/microsoft/playwright-mcp)
[![MCP](https://img.shields.io/badge/MCP-Model_Context_Protocol-blue)](https://modelcontextprotocol.io/)
[![Brave](https://img.shields.io/badge/Brave-Browser-FB542B?logo=brave&logoColor=white)](https://brave.com/)
  ...
  "mcpServers": {
    "playwright": {
      ...
      "args": [
        ...
        "--config",
        "C:/Users/user/Desktop/playwright-mcp-config/config.json"
      ]
    }
  }
}
...
本リポジトリの設定ファイルはMITライセンスです。元の `@playwright/mcp` は [Apache-2.0ライセンス](https://github.com/microsoft/playwright-mcp/blob/main/LICENSE) で提供されています。
